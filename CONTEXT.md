...
- **Dictation Worker** — das Modul, das den Strom von Utterances verarbeitet: besitzt die STT-Engine und das Cleanup-LLM, verwaltet deren Lebenszyklus (Lazy-Load, Fehler-Cache, Modellwechsel zur Laufzeit, Live-Aktivierung nach Modell-Download) und liefert pro Utterance den fertigen Text oder einen sichtbaren Ablehnungsgrund. Genau einer pro laufender App, läuft abseits des Main-Threads.
